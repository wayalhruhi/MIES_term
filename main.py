...
X_ark = extractor.features(13,"../working/Mouse-Dynamics/data/arka/")
X_ark= pd.DataFrame(X_ark)
X_ark['Class']=1
print('\nDataset 2 extracted')

X_prv = extractor.features(13,"../working/Mouse-Dynamics/data/prativa/")
X_prv= pd.DataFrame(X_prv)
X_prv['Class']=2
print('\nDataset 3 extracted')

X_deb = extractor.features(13,"../working/Mouse-Dynamics/data/debalina/")
X_deb= pd.DataFrame(X_deb)
X_deb['Class']=3
print('\nDataset 4 extracted')

X_arn = extractor.features(13,"../working/Mouse-Dynamics/data/aryendra/")
X_arn= pd.DataFrame(X_arn)
X_arn['Class']=4
print('\nDataset 5 extracted')

X_avd = extractor.features(13,"../working/Mouse-Dynamics/data/avadh/")
X_avd= pd.DataFrame(X_avd)
X_avd['Class']=5
print('\nDataset 6 extracted')

X_ksn = extractor.features(13,"../working/Mouse-Dynamics/data/kasana/")
X_ksn= pd.DataFrame(X_ksn)
X_ksn['Class']=6
print('\nDataset 7 extracted')

X_hrs = extractor.features(13,"../working/Mouse-Dynamics/data/harsh/")
X_hrs= pd.DataFrame(X_hrs)
X_hrs['Class']=7
print('\nDataset 8 extracted')

X_dhn = extractor.features(13,"../working/Mouse-Dynamics/data/dhananjay/")
